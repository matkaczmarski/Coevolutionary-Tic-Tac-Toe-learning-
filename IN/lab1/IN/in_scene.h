...
namespace mini
{
	...
	public:
		...
		{ }
		void HandleGesture(KinectController::GestureType gesture, double diff);
		void HandleSpeech(std::string command);
		void HandleHeadTracking(float pitch, float roll, float yaw);
